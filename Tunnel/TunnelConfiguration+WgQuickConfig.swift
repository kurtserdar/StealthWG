...
//
// Vendored verbatim from wireguard-apple Sources/Shared (the wg-quick parser is
// not part of the WireGuardKit SwiftPM product). Only `import WireGuardKit` was
// added so the public config types resolve outside their original module.
